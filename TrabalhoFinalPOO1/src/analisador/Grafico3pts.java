...
public static void gerarHtml(List<Atleta> vetor) throws IOException {
		...
		String htmlGera = "<html>\r\n" + 
				...
				"      data.addColumn('number', 'Total de 3 pontos');\r\n" + 
		...
		FileWriter arq = new FileWriter("C:\\Users\\Vinicius\\Desktop\\grafico3pts.html");
	...
	private static String dadosGrafico(List<Atleta> vetor) {
		...
		for (Atleta atleta:vetor) {
			...
			dados += "['"+ atleta.getNome()+ "' , " + String.valueOf(atleta.getLista().get(i).getPts3_tentadas()) + ", " + String.valueOf(atleta.getLista().get(i).getPts3_certas())+ " , " + String.valueOf(atleta.getLista().get(i).getPts3_tentadas()*3) +"],\r\n";
