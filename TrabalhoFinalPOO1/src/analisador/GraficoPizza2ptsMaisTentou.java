...
public class GraficoPizza2ptsMaisTentou {
...
public static void gerarHtml(List<Atleta> vetor) throws IOException {
		...
		String htmlGera = "<html>\r\n" + 
		  ...
		  "<head>"+
			...
			"\r\n" + 
		        "var options = {"+
		         " title: 'Mais Tentou Chutes de 2 pts (em Quantidade)',"+
		         " is3D: true,"+
		       " };"+
		...
		FileWriter arq = new FileWriter("C:\\Users\\Vinicius\\Desktop\\graficoPizzaMaisTentou2pts.html");
	...
	for (Atleta atleta:vetor) {
		for (int i = 0;i < atleta.getLista().size() ;i++) {
			dados += "['"+ atleta.getNome()+ "' , " + String.valueOf(atleta.getLista().get(i).getPts2_tentadas()) + ", " + String.valueOf(atleta.getLista().get(i).getPts2_certas()) +"],\r\n";
