...
public static void gerarHtml(List<Atleta> vetor) throws IOException {
		...
		String htmlGera = "<html>\r\n" + 
				...
				"      data.addColumn('number', 'Arremessos Tentados Em Lances Livres');\r\n" + 
				"      data.addColumn('number', 'Arremessos Acertados em Lances Livres');\r\n" + 
				"      data.addColumn('number', 'Total de pontos em Lances livres ');\r\n" + 
		...
		FileWriter arq = new FileWriter("C:\\Users\\Vinicius\\Desktop\\graficoFT.html");
	...
	private static String dadosGrafico(List<Atleta> vetor) {
		...
		for (Atleta atleta:vetor) {
			...
			dados += "['"+ atleta.getNome()+ "' , " + String.valueOf(atleta.getLista().get(i).getFT_tentadas()) + ", " + String.valueOf(atleta.getLista().get(i).getFT_certas())+ ", " + String.valueOf(atleta.getLista().get(i).getFT_certas()) +"],\r\n";
