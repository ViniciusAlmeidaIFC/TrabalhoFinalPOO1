...
public class GraficoPizza3ptsMaisTentou {
...
public static void gerarHtml(List<Atleta> vetor) throws IOException {
		...
		FileWriter arq = new FileWriter("C:\\Users\\Vinicius\\Desktop\\graficoPizzaMaisTentou3pts.html");
	...
	for (Atleta atleta:vetor) {
		for (int i = 0;i < atleta.getLista().size() ;i++) {
			dados += "['"+ atleta.getNome()+ "' , " + String.valueOf(atleta.getLista().get(i).getPts3_tentadas()) + ", " + String.valueOf(atleta.getLista().get(i).getPts3_certas()) +"],\r\n";
