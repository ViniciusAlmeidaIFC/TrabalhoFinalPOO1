...
public class GraficoPizza3ptsMaisAcertou {
...
public static void gerarHtml(List<Atleta> vetor) throws IOException {
		...
		String htmlGera = "<html>\r\n" + 
		  ...
		  "<head>"+
			...
			"\r\n" + 
		        "var options = {"+
		         "title: 'Mais Acertou Chutes de 3 pts (em Quantidade)',"+
		         " is3D: true,"+
		       " };"+
		...
		FileWriter arq = new FileWriter("C:\\Users\\Vinicius\\Desktop\\graficoPizzaMaisChutes3pts.html");
	...
	for (Atleta atleta:vetor) {
		for (int i = 0;i < atleta.getLista().size() ;i++) {
			dados += "['"+ atleta.getNome()+ "' , " + String.valueOf(atleta.getLista().get(i).getPts3_certas()) + ", " + String.valueOf(atleta.getLista().get(i).getPts3_tentadas()) +"],\r\n";
